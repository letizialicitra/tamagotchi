...
//	 <i> 0 This interrupt is disabled //VA ATTIVATO SE VUOI ENTRARE NELL'IRQHANDLER ALLA SCADENZA DEL TIMER
//   </e>
//   <e.1> MR0R
//	 <i> 1 Reset on MR0: the TC will be reset if MR0 matches it.
//	 <i> 0 Feature disabled. //VA ATTIVATO SE VUOI CHE IL TIMER SI RIAZZERI
//   </e>
//   <e.2> MR0S
//	 <i> 1 Stop on MR0: the TC and PC will be stopped and TCR[0] will be set to 0 if MR0 matches the TC
//	 <i> 0 Feature disabled. //stoppo il timer
//   </e>
//   <e.3> MR1I
