...
void LCD_DrawTriangleUp (uint16_t X_start, uint16_t Y_start, uint16_t width, uint16_t height, uint16_t color);
void LCD_DrawTriangleDown (uint16_t X_start, uint16_t Y_start, uint16_t width, uint16_t height, uint16_t color);
